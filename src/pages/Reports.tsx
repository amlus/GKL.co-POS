...
const Reports: React.FC = () => {
  ...
  const exportToCSV = () => {
    ...
    const headers = ['ID Transaksi', 'Tanggal', 'Waktu', 'Kasir', 'Subtotal', 'Diskon', 'Total Akhir', 'Metode Pembayaran'];
          ...
          <div className="space-y-4">
            ...
            {topProducts.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-sm">Belum ada data penjualan untuk periode ini.</p>
              </div>
            )}
          </div>
        </div>
